...
* In the name I memorize their x-z position on the board, while in id I have color-position in the array-piece */
	loader.load("./models/wpawn.js",function(geometry,materials) {
	...
	loader.load("./models/wrook.js",function(geometry,materials) {
	...
	loader.load("./models/wknight.js",function(geometry,materials) {
	...
	loader.load("./models/wbishop.js",function(geometry,materials) {
	...
	loader.load("./models/wking.js",function(geometry,materials) {
	...
	loader.load("./models/wqueen.js",function(geometry,materials) {
...
// I create the black pieces, so it is true when said for the whites
	loader.load("./models/bpawn.js",function(geometry,materials) {
	...
	loader.load("./models/brook.js",function(geometry,materials) {
	...
	loader.load("./models/bknight.js",function(geometry,materials) {
	...
	loader.load("./models/bbishop.js",function(geometry,materials) {
	...
	loader.load("./models/bking.js",function(geometry,materials) {
	...
	loader.load("./models/bqueen.js",function(geometry,materials) {
...
// This function matches each piece with the right function to calculate the moves based on the type contained in the id
...
// Calculate the moves of the rooks
...
// If the game is over I go back to the first scene, otherwise I change turns and turn the camera
		if(end!=0) {
			if(end==-1)
